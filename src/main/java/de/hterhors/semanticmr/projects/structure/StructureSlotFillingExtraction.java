package de.hterhors.semanticmr.projects.structure;
...
import de.hterhors.semanticmr.projects.structure.specs.StructureSpecifications;
 ...
 *
 */
public class StructureSlotFillingExtraction extends AbstractSemReadProject {
	...
	public static void main(String[] args) {
		new StructureSlotFillingExtraction();
	}

	private static Logger log = LogManager.getFormatterLogger(StructureSlotFillingExtraction.class);

	/**
	 * The directory of the corpus instances. In this example each instance is
	 * stored in its own json-file.
	 */
	private final File instanceDirectory = new File("src/main/resources/structure/corpus/instances/");
	 ...
	 */
	private final File externalNerlaAnnotations = new File("src/main/resources/structure/corpus/nerla/");

	public StructureSlotFillingExtraction() {
		...
		super(SystemScope.Builder.getSpecsHandler()
				 ...
				 */
				.addScopeSpecification(StructureSpecifications.systemsScopeReader)
				/**
...
//				slotPairConstraitsSpecifications);
		...
		IStateInitializer stateInitializer = ((instance) -> new State(instance,
				new Annotations(new EntityTemplate(AnnotationBuilder.toAnnotation("ArchitecturalStructure")))));
...
//		AbstractSampler sampler = new EpochSwitchSampler(e -> new Random(e).nextBoolean());
		 ...
		 */
		final File modelBaseDir = new File("models/structure/");
		final String modelName = "structure" + new Random().nextInt(1000000);
