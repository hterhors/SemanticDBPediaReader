...
import de.hterhors.semanticmr.projects.soccerplayer.specs.SoccerPlayerSpecifications;
import de.hterhors.semanticmr.projects.soccerplayer.templates.BirthDeathYearPairTemplate;
import de.hterhors.semanticmr.projects.soccerplayer.templates.BirthDeathYearTemplate;
...
public class SoccerPlayerSlotFillingExtraction extends AbstractSemReadProject {
	 ...
	 */
	private final File externalNerlaAnnotations = new File("src/main/resources/soccerplayer/corpus/nerla/");
	...
	public SoccerPlayerSlotFillingExtraction() {
		...
		super(SystemScope.Builder.getSpecsHandler()
				 ...
				 */
				.addScopeSpecification(SoccerPlayerSpecifications.systemsScopeReader)
				/**
...
//				slotPairConstraitsSpecifications);
		...
		/**
		 * Data set specific templates.
		 */
		featureTemplates.add(new BirthDeathYearPairTemplate());
		featureTemplates.add(new BirthDeathYearTemplate(candidateRetrieval));
