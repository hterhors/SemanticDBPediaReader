package de.hterhors.semanticmr.projects.film;
...
import de.hterhors.semanticmr.projects.film.specs.FilmSpecifications;
 ...
 *
 */
public class FilmSlotFillingExtraction extends AbstractSemReadProject {
	...
	public static void main(String[] args) {
		new FilmSlotFillingExtraction();
	}

	private static Logger log = LogManager.getFormatterLogger(FilmSlotFillingExtraction.class);

	/**
	 * The directory of the corpus instances. In this example each instance is
	 * stored in its own json-file.
	 */
	private final File instanceDirectory = new File("src/main/resources/film/corpus/instances/");
	 ...
	 */
	private final File externalNerlaAnnotations = new File("src/main/resources/film/corpus/nerla/");

	public FilmSlotFillingExtraction() {
		...
		super(SystemScope.Builder.getScopeHandler()
				 ...
				 */
				.addScopeSpecification(FilmSpecifications.systemsScopeReader)
				/**
				 ...
				 */
				.build());
		System.out.println(EntityType.get("Film").getHierarchicalEntityTypes().size());
		...
		System.out.println(EntityType.get("Actor").getHierarchicalEntityTypes().size());
		System.out.println(EntityType.get("Organisation").getHierarchicalEntityTypes().size());
...
//				slotPairConstraitsSpecifications);
		...
		IStateInitializer stateInitializer = ((instance) -> new State(instance,
				new Annotations(new EntityTemplate(AnnotationBuilder.toAnnotation("Film")))));
...
//		AbstractSampler sampler = new EpochSwitchSampler(e -> new Random(e).nextBoolean());
		 ...
		 */
		final File modelBaseDir = new File("models/film/");
		final String modelName = "film" + new Random().nextInt(1000000);
